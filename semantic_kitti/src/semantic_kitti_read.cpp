...
int main(int argc, char** argv){
    ...
    // ##################### data path ########################
//    string datapath = "/media/llz/Extreme SSD/KITTI/dataset/sequences/01/velodyne/";
//    string lablespath = "/media/llz/Extreme SSD/KITTI/dataset/sequences/01/labels/";
    string datapath, lablespath;
    nh.getParam("/datapath", datapath);
    nh.getParam("/lablespath", lablespath);
    ...
    int frame = 0;
    float frequency;
    nh.getParam("/scan_period", frequency);
    ros::Rate r(1/frequency);
